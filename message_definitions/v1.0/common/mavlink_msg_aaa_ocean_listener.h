...
#define MAVLINK_MSG_ID_AAA_OCEAN_LISTENER_LEN 10
#define MAVLINK_MSG_ID_AAA_OCEAN_LISTENER_MIN_LEN 10
#define MAVLINK_MSG_ID_227_LEN 10
#define MAVLINK_MSG_ID_227_MIN_LEN 10

#define MAVLINK_MSG_ID_AAA_OCEAN_LISTENER_CRC 56
#define MAVLINK_MSG_ID_227_CRC 56
...
static inline uint16_t mavlink_msg_aaa_ocean_listener_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint16_t air_conditioner, uint64_t time_usec)
{
...
{
    return mavlink_msg_aaa_ocean_listener_pack(system_id, component_id, msg, aaa_ocean_listener->air_conditioner, aaa_ocean_listener->time_usec);
}
...
{
    return mavlink_msg_aaa_ocean_listener_pack_chan(system_id, component_id, chan, msg, aaa_ocean_listener->air_conditioner, aaa_ocean_listener->time_usec);
}
...
static inline void mavlink_msg_aaa_ocean_listener_send(mavlink_channel_t chan, uint16_t air_conditioner, uint64_t time_usec)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_AAA_OCEAN_LISTENER_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_aaa_ocean_listener_send(chan, aaa_ocean_listener->air_conditioner, aaa_ocean_listener->time_usec);
#else
 ...
 */
static inline void mavlink_msg_aaa_ocean_listener_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t air_conditioner, uint64_t time_usec)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
