...
TEST(common, AAA_OCEAN_LISTENER)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::AAA_OCEAN_LISTENER packet_in{};
    packet_in.air_conditioner = 17651;
    packet_in.boat_speed = 17755;
    packet_in.time_usec = 93372036854775807ULL;

    mavlink::common::msg::AAA_OCEAN_LISTENER packet1{};
    mavlink::common::msg::AAA_OCEAN_LISTENER packet2{};
    ...
    EXPECT_EQ(packet1.air_conditioner, packet2.air_conditioner);
    EXPECT_EQ(packet1.boat_speed, packet2.boat_speed);
    EXPECT_EQ(packet1.time_usec, packet2.time_usec);
}

#ifdef TEST_INTEROP
TEST(common_interop, AAA_OCEAN_LISTENER)
{
    mavlink_message_t msg;
    ...
    mavlink_aaa_ocean_listener_t packet_c {
    ...
    mavlink_msg_aaa_ocean_listener_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.air_conditioner, packet2.air_conditioner);
    EXPECT_EQ(packet_in.boat_speed, packet2.boat_speed);
    EXPECT_EQ(packet_in.time_usec, packet2.time_usec);
...
TEST(common, AAA_OFFBOARD_TO_FCU)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::AAA_OFFBOARD_TO_FCU packet_in{};
    packet_in.power_on = 17235;

    mavlink::common::msg::AAA_OFFBOARD_TO_FCU packet1{};
    mavlink::common::msg::AAA_OFFBOARD_TO_FCU packet2{};
    ...
    EXPECT_EQ(packet1.power_on, packet2.power_on);
}

#ifdef TEST_INTEROP
TEST(common_interop, AAA_OFFBOARD_TO_FCU)
{
    mavlink_message_t msg;
    ...
    mavlink_aaa_offboard_to_fcu_t packet_c {
         17235
    };
    ...
    mavlink_msg_aaa_offboard_to_fcu_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.power_on, packet2.power_on);
